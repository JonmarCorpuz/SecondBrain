The Link Layer Discovery Protocol is a vendor-neutral protocol used in Ethernet networks to advertise and discover information about networking devices that are directly connected to each other
